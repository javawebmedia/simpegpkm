  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ asset('admin/rumpun/tambah') }}" method="post" accept-charset="utf-8">
        {{ csrf_field() }}

        <div class="form-group row">
          <label class="col-md-3">Nama Rumpun</label>
          <div class="col-md-9">
            <input type="text" name="nama_rumpun" class="form-control" placeholder="Nama rumpun" value="{{ old('nama_rumpun') }}" required>
          </div>
        </div>
