...
<div class="col-md-12">
 <div class="form-group">
    ...
    <textarea name="tentang" rows="3" class="form-control tinymce-editor" id="kontenku" id="isi" placeholder="Summary of the company"><?php echo $site->tentang ?></textarea>
    </div>
</div>

<div class="col-md-12">
 <div class="form-group">
    <label>Pengumuman Kepegawaian</label>
    <textarea name="pengumuman" rows="3" class="form-control" id="pengumuman" placeholder="pengumuman"><?php echo $site->pengumuman ?></textarea>
    </div>
</div>
...
<div class="col-md-6">
    <h3>Setting Menit Standar Kinerja</h3><hr>

    <div class="form-group">
    <label>Maksimal Menit Harian</label>
    <input type="number" name="max_menit_harian" placeholder="Maksimal Menit Harian" value="<?php echo $site->max_menit_harian ?>" class="form-control">
    </div>

    <div class="form-group">
    <label>Maksimal Menit Bulanan</label>
    <input type="number" name="max_menit_bulanan" placeholder="Maksimal Menit Bulanan" value="<?php echo $site->max_menit_bulanan ?>" class="form-control">
    </div>
