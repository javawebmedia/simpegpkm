  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ asset('admin/agama/tambah') }}" method="post" accept-charset="utf-8">
        {{ csrf_field() }}

        <div class="form-group row">
          <label class="col-md-3">Nama Agama</label>
          <div class="col-md-9">
            <input type="text" name="nama_agama" class="form-control" placeholder="Nama agama" value="{{ old('nama_agama') }}" required>
          </div>
        </div>
