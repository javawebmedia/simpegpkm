<div class="row">
	...
	<div class="col-md-6">
		<form action="{{ asset('admin/kode-diklat/proses-import') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="alert alert-light">
		{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<a href="{{ asset('admin/kode-diklat') }}" class="btn btn-dark">
