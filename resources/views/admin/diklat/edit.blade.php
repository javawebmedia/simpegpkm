...
<form action="{{ asset('admin/diklat/proses-edit') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
  {{ csrf_field() }}
      ...
      <div class="form-group row">
        ...
        <div class="col-md-7">
          <select name="nip" class="form-control select2" required>
            ...
            <?php foreach($pegawai as $pegawai) { ?>
              <option value="<?php echo $pegawai->nip ?>" <?php if($diklat->nip==$pegawai->nip) { echo 'selected'; } ?>>
        ...
        <div class="col-md-2">
          <select name="status_diklat" class="form-control">
            ...
            <option value="Menunggu" <?php if($diklat->status_diklat=='Menunggu') { echo 'selected'; } ?>>Menunggu</option>
            <option value="Ditolak" <?php if($diklat->status_diklat=='Ditolak') { echo 'selected'; } ?>>Ditolak</option>
          </select>
        </div>
      </div>
      ...
      <script>
        ...
        <div class="col-md-4">
          <select name="id_rumpun" class="form-control" id="id_rumpun" required>
                ...
                <option value="<?php echo $rumpun2->id_rumpun ?>" <?php if($diklat->id_rumpun==$rumpun2->id_rumpun) { echo 'selected'; } ?>>
        ...
        <div class="col-md-5">
            <select name="id_jenis_pelatihan" class="form-control" id="id_jenis_pelatihan" required>
              ...
              <option value="<?php echo $jenis_pelatihan->id_jenis_pelatihan ?>"  class="{{ $jenis_pelatihan->id_rumpun }}" <?php if($diklat->id_jenis_pelatihan==$jenis_pelatihan->id_jenis_pelatihan) { echo 'selected'; } ?>>
