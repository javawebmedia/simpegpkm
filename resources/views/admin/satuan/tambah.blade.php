  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{ asset('admin/satuan/tambah') }}" method="post" accept-charset="utf-8">
        {{ csrf_field() }}

        <div class="form-group row">
          <label class="col-md-3">Nama Satuan</label>
          <div class="col-md-9">
            <input type="text" name="nama_satuan" class="form-control" placeholder="Nama satuan" value="{{ old('nama_satuan') }}" required>
          </div>
        </div>
