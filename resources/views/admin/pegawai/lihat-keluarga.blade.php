...
<form action="{{ asset('admin/pegawai/edit-keluarga') }}" method="post" accept-charset="utf-8">
  {{ csrf_field() }}
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
      <select name="status_perkawinan" id="status_perkawinan" class="form-control" required>
        ...
        <option value="Cerai Mati" @if($keluarga->status_perkawinan === 'Cerai Mati') selected @endif>Cerai Mati</option>
      </select>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-md-9">
      <a href="{{ asset('admin/pegawai/riwayat/'.$pegawai->id_pegawai) }}#pendidikan" class="btn btn-default">
