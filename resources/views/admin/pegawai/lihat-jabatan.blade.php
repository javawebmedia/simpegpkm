...
@endif
        ...
        <form action="{{ asset('admin/pegawai/edit-jabatan') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9">
            <a href="{{ asset('admin/pegawai/riwayat/'.$pegawai->id_pegawai) }}#jabatan" class="btn btn-default" data-dismiss="modal"><i class="fa fa-arrow-left"></i> Kembali</a>
