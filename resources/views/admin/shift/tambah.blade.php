      ...
      <div class="modal-body">
        ...
        {{ csrf_field() }}
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" name="jam_mulai" id="timepicker" class="form-control" placeholder="Jam" value="{{ old('jam_mulai') }}" required>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" name="jam_selesai" id="timepicker2" class="form-control" placeholder="Jam" value="{{ old('jam_selesai') }}" required>
            </div>
          </div>
