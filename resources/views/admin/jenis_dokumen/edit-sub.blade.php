 ...
 <div class="modal fade" id="edit-sub<?php echo $sub_jenis_dokumen->id_sub_jenis_dokumen ?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
				<form action="{{ asset('admin/jenis-dokumen/edit-sub') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}

	<input type="hidden" name="id_jenis_dokumen" value="{{ $jenis_dokumen->id_jenis_dokumen }}">
	<input type="hidden" name="id_sub_jenis_dokumen" value="{{ $sub_jenis_dokumen->id_sub_jenis_dokumen }}">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input type="text" name="kode_sub_jenis_dokumen" class="form-control" placeholder="Kode Sub Jenis Dokumen Pegawai" value="{{ $sub_jenis_dokumen->kode_sub_jenis_dokumen }}" required>
						<small class="text-secondary">Kode Sub Jenis Dokumen Pegawai</small>
					</div>
					<div class="col-sm-5">
						<input type="number" name="urutan" class="form-control" placeholder="Nomor Urut Sub Jenis Dokumen Pegawai" value="{{ $sub_jenis_dokumen->urutan }}" required>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<input type="file" name="gambar" class="form-control" placeholder="Upload Foto" value="{{ $sub_jenis_dokumen->gambar }}">
					</div>
				</div>
