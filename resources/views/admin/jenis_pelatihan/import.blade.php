<div class="row">
	...
	<div class="col-md-6">
		<form action="{{ asset('admin/jenis-pelatihan/proses-import') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="alert alert-light">
		{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<a href="{{ asset('admin/jenis-pelatihan') }}" class="btn btn-dark">
