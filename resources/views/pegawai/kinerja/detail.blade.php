...
<form action="{{ asset('pegawai/kinerja/proses') }}" method="post">
{{ csrf_field() }}
...
<div class="input-group">
	...
	<span class="input-group-append">
		...
		<a href="{{ asset('pegawai/kinerja/approval?tanggal_kinerja='.$tanggal_kinerja) }}" class="btn btn-outline-success btn-flat"><i class="fa fa-arrow-left"></i> Kembali</a>
