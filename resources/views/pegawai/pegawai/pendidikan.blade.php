		...
		<table class="table table-sm tabelku">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{ asset('pegawai/pegawai/lihat-pendidikan/'.$pendidikan->id_pendidikan) }}" class="btn btn-warning btn-sm mb-1" title="Edit"><i class="fa fa-edit"></i></a>

						<a href="{{ asset('pegawai/pegawai/delete-pendidikan/'.$pendidikan->id_pendidikan) }}" class="btn btn-dark btn-sm mb-1 delete-link" title="Hapus"><i class="fa fa-trash"></i></a>
					</td>
				</tr>
				<?php $no++; } ?>
			</tbody>
