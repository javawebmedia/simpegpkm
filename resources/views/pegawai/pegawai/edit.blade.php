...
<form action="{{ asset('pegawai/pegawai/proses-edit') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="form-group row">
  ...
  <div class="col-md-4">
    <select name="akses_level" id="akses_level" class="form-control" required>
      <option value="{{ $pegawai->akses_level }}">{{ $pegawai->akses_level }}</option>
    </select>
  </div>
...
<div class="form-group row">
  ...
  <div class="col-md-9">
    ...
    <a href="{{ asset('pegawai/pegawai') }}" class="btn btn-secondary">
