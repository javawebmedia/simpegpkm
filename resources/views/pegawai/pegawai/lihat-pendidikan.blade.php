...
@endif
        ...
        <form action="{{ asset('pegawai/pegawai/edit-pendidikan') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9">
            <a href="{{ asset('pegawai/pegawai/riwayat') }}#pendidikan" class="btn btn-default" data-dismiss="modal"><i class="fa fa-arrow-left"></i> Kembali</a>
