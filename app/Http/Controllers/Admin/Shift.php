...
class Shift extends Controller
{
    ...
    public function tambah(Request $request)
    {
        ...
        DB::table('shift')->insert([
            ...
            'kode'                  => $request->kode,
            'nama'                  => $request->nama,
            'start_jam_mulai'       => $request->start_jam_mulai,
            'jam_mulai'             => $request->jam_mulai,
            'end_jam_mulai'         => $request->end_jam_mulai,
            'start_jam_selesai'     => $request->start_jam_selesai,
            'jam_selesai'           => $request->jam_selesai,
            'end_jam_selesai'       => $request->end_jam_selesai,
            'hari'                  => '-',
